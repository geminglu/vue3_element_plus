      ...
      <div class="header">
        ...
        <div class="butgure">
          <template v-if="showFullscreen">
            <span
              v-if="isFullscreen"
              class="butitem InsightCloud InsightCloud-window-window_line"
              @click="handelFullscreen(false)"
            />
            <span
              v-else
              class="butitem InsightCloud InsightCloud-window-max_line"
              @click="handelFullscreen(true)"
            />
          </template>
          <span
            v-if="showClose"
            class="butitem InsightCloud InsightCloud-shanchu2"
            @click="close"
          />
        </div>
      </div>
